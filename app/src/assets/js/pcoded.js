...
for (var l = 0; l < elem.length; l++) {
  ...
  console.log("page url", window.location.href, elem[l].href, pageUrl.startsWith(elem[l].href))
  if ((elem[l].href == window.location.href || elem[l].href == pageUrl) && elem[l].getAttribute('href') != '') {
